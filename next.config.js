...
const nextConfig = {
  ...
  async headers() {
    ...
    return [
      ...
      // ✅ Páginas de parcelas (pueden cambiar precios) - 1 hora con stale-while-revalidate
      {
        source: '/parcelas/:path*',
        headers: [
          {
            key: 'Cache-Control',
  ...
  async redirects() {
    ...
    return [
      // ================================================================
      // Admin: vehiculos → parcelas, equipamiento → caracteristicas (Eco Area Limonar)
      // ================================================================
      { source: '/administrator/vehiculos', destination: '/administrator/parcelas', permanent: true },
      { source: '/administrator/vehiculos/:path*', destination: '/administrator/parcelas/:path*', permanent: true },
      { source: '/administrator/equipamiento', destination: '/administrator/caracteristicas', permanent: true },

      // ================================================================
      // GRUPO 1: NORMALIZACIÓN DE DOMINIO (CRÍTICO)
      // ================================================================
      // Propósito: Forzar www como URL canónica (configura tu dominio en NEXT_PUBLIC_APP_URL)
      // Añade redirects para tu dominio cuando lo tengas
      // Ejemplo: { source: '/:path*', has: [{ type: 'host', value: 'tudominio.com' }], destination: 'https://www.tudominio.com/:path*', permanent: true },
      ...
      { source: '/de/vehiculos/:slug', destination: '/de/stellplatze/:slug', permanent: true },
      { source: '/de/vehicules', destination: '/de/stellplatze', permanent: true },
      { source: '/de/vehicules/:slug', destination: '/de/stellplatze/:slug', permanent: true },
      { source: '/de/parcels', destination: '/de/stellplatze', permanent: true },
      { source: '/de/parcels/:slug', destination: '/de/stellplatze/:slug', permanent: true },
      { source: '/de/emplacements', destination: '/de/stellplatze', permanent: true },
      { source: '/de/emplacements/:slug', destination: '/de/stellplatze/:slug', permanent: true },
      { source: '/de/fahrzeuge', destination: '/de/stellplatze', permanent: true },
      { source: '/de/fahrzeuge/:slug', destination: '/de/stellplatze/:slug', permanent: true },
      ...
      // ── Francés (FR): Corregir rutas EN/ES/DE → FR ──
      { source: '/fr/vehicles', destination: '/fr/emplacements', permanent: true },
      { source: '/fr/vehicles/:slug', destination: '/fr/emplacements/:slug', permanent: true },
      { source: '/fr/vehiculos', destination: '/fr/emplacements', permanent: true },
      { source: '/fr/vehiculos/:slug', destination: '/fr/emplacements/:slug', permanent: true },
      { source: '/fr/vehicules', destination: '/fr/emplacements', permanent: true },
      { source: '/fr/vehicules/:slug', destination: '/fr/emplacements/:slug', permanent: true },
      { source: '/fr/parcels', destination: '/fr/emplacements', permanent: true },
      { source: '/fr/parcels/:slug', destination: '/fr/emplacements/:slug', permanent: true },
      { source: '/fr/stellplatze', destination: '/fr/emplacements', permanent: true },
      { source: '/fr/stellplatze/:slug', destination: '/fr/emplacements/:slug', permanent: true },
      ...
      // ── Inglés (EN): Corregir rutas ES/FR/DE → EN ──
      { source: '/en/vehiculos', destination: '/en/parcels', permanent: true },
      { source: '/en/vehiculos/:slug', destination: '/en/parcels/:slug', permanent: true },
      { source: '/en/vehicles', destination: '/en/parcels', permanent: true },
      { source: '/en/vehicles/:slug', destination: '/en/parcels/:slug', permanent: true },
      { source: '/en/vehicules', destination: '/en/parcels', permanent: true },
      { source: '/en/vehicules/:slug', destination: '/en/parcels/:slug', permanent: true },
      { source: '/en/emplacements', destination: '/en/parcels', permanent: true },
      { source: '/en/emplacements/:slug', destination: '/en/parcels/:slug', permanent: true },
      { source: '/en/stellplatze', destination: '/en/parcels', permanent: true },
      { source: '/en/stellplatze/:slug', destination: '/en/parcels/:slug', permanent: true },
      ...
      { source: '/es/fahrzeuge', destination: '/es/parcelas', permanent: true },
      { source: '/es/fahrzeuge/:slug', destination: '/es/parcelas/:slug', permanent: true },
      { source: '/es/vehicles', destination: '/es/parcelas', permanent: true },
      { source: '/es/vehicles/:slug', destination: '/es/parcelas/:slug', permanent: true },
      { source: '/es/vehicules', destination: '/es/parcelas', permanent: true },
      { source: '/es/vehicules/:slug', destination: '/es/parcelas/:slug', permanent: true },
      { source: '/es/vehiculos', destination: '/es/parcelas', permanent: true },
      { source: '/es/vehiculos/:slug', destination: '/es/parcelas/:slug', permanent: true },
      { source: '/es/parcels', destination: '/es/parcelas', permanent: true },
      { source: '/es/parcels/:slug', destination: '/es/parcelas/:slug', permanent: true },
      { source: '/es/emplacements', destination: '/es/parcelas', permanent: true },
      { source: '/es/emplacements/:slug', destination: '/es/parcelas/:slug', permanent: true },
      { source: '/es/stellplatze', destination: '/es/parcelas', permanent: true },
      { source: '/es/stellplatze/:slug', destination: '/es/parcelas/:slug', permanent: true },
