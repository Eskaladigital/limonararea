...
// Eco Area Limonar: sin Daños, sin Ubicaciones. Equipamiento → Características
const navigation: NavItem[] = [
  { name: "Dashboard", href: "/administrator", icon: LayoutDashboard },
  { name: "Informes", href: "/administrator/informes", icon: BarChart3 },
  { name: "Parcelas", href: "/administrator/parcelas", icon: Home },
  ...
  { name: "Características", href: "/administrator/caracteristicas", icon: Wrench },
...
function AdminSidebarComponent({ admin, isOpen = true, onClose }: AdminSidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={`
          fixed left-0 top-0 w-64 bg-earth-deep h-screen flex flex-col z-50
      ...
      <div className="p-4 border-t border-white/10">
        <div className="flex items-center gap-3 px-4 py-3">
          <div className="w-10 h-10 rounded-full bg-clay flex items-center justify-center text-white font-bold">
