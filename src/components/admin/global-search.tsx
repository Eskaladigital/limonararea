    ...
    <div ref={searchRef} className="relative flex-1 max-w-2xl">
      ...
      <div className="relative">
        <input
          ...
          className="w-full pl-4 pr-10 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-clay focus:border-transparent transition-all"
        />
        {!loading && !query && (
                ...
                <div className="divide-y divide-gray-100">
                  {results.extras.map((extra) => (
                    <button
                      ...
                      className="w-full px-4 py-3 hover:bg-clay/10 transition-colors text-left flex items-center justify-between group"
                    >
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          <span className="font-medium text-gray-900">
