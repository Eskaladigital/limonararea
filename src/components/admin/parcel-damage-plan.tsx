    ...
    <div className={`bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden ${className}`}>
      ...
      >
            ...
            >
              <div
                className={`w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold shadow-md border-2 ${
                  isSelected ? 'ring-2 ring-offset-1 ring-clay' : ''
                }`}
                style={{
        ...
        {isEditing && hoverPosition && (
          <div
            className="absolute w-6 h-6 rounded-full border-2 border-dashed border-clay bg-clay/20 transform -translate-x-1/2 -translate-y-1/2 pointer-events-none"
            style={{
        ...
        {isEditing && (
          <div className="absolute bottom-2 left-2 right-2 text-center">
            <span className="inline-flex items-center px-2 py-1 bg-clay/10 text-clay text-xs rounded-full">
