...
export function ParcelGallery({ images, parcelName }: ParcelGalleryProps) {
  ...
  return (
    <>
      {/* VERSIÓN ÚNICA RESPONSIVA - igual que reservar/parcela */}
      <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
        {/* Imagen principal */}
        <div className="relative aspect-[16/10] bg-gradient-to-br from-gray-900 to-gray-800 group">
          <img
            src={currentImage.image_url}
            alt={currentImage.alt_text || `${parcelName} - Imagen ${currentIndex + 1}`}
              ...
              <div className="flex gap-2 md:gap-3 overflow-x-auto pb-2 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
                {sortedImages.map((image, index) => (
                  ...
                  >
                    <img
                      src={image.image_url}
                      alt={image.alt_text || `${parcelName} - Miniatura ${index + 1}`}
