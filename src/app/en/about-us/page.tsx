...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: "About Us | Eco Area Limonar",
    description:
      "Discover Eco Area Limonar, a motorhome area in Los Nietos, on the shores of the Mar Menor. Premium pitches, full services and 320 days of sunshine.",
    keywords:
      "eco area limonar, about us, motorhome area Los Nietos, camping Mar Menor, Cartagena Murcia",
    openGraph: {
      title: "About Us | Eco Area Limonar",
      description:
        "Premium motorhome area on the shores of the Mar Menor. Discover our story.",
      type: "website",
