...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: "Motorhome Pitches | Eco Area Limonar",
    description:
      "Discover our spacious and equipped pitches in Los Nietos, Mar Menor. Electricity, water, WiFi and all services included. From 95€/day.",
    keywords:
      "motorhome pitches, camping Mar Menor, eco area limonar pitches, Los Nietos pitches, Cartagena",
    openGraph: {
      title: "Motorhome Pitches | Eco Area Limonar",
      description:
        "Spacious pitches with all services on the Mar Menor. From 95€/day.",
      type: "website",
