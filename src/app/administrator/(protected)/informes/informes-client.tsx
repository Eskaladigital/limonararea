      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Análisis de rendimiento • <span className="font-medium text-clay">{periodDescription}</span>
          </p>
        </div>
        <div className="flex items-center gap-3">
          ...
          >
            ...
            Filtros
            {hasActiveFilters && (
              <span className="bg-white text-clay text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center">
                !
              </span>
            )}
          </button>
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-2 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-clay focus:border-transparent"
                />
                <input
                  type="date"
                  value={dateRange?.end ?? ""}
              ...
              {vehicleStats.length > 0 && (
                <tfoot className="bg-gray-50">
                  <tr>
                    ...
                    <td className="text-right py-3 px-2 font-bold text-clay">{occupancyData.percentage}%</td>
              ...
              <tbody>
                  ...
                  return (
                    <React.Fragment key={year}>
                      ...
                      >
                        ...
                        <td className="text-right py-3 px-4 font-bold text-clay bg-orange-50">
                      ...
                      {isExpanded && (
                        <tr className="border-b-2 border-gray-300 bg-gray-100 font-semibold">
                          ...
                          <td className="text-right py-3 px-4 font-bold text-clay bg-orange-100">
                            {formatPrice(yearData.yearTotal)}
                          </td>
                        </tr>
                      )}
                ...
                {revenueControlTable.years.length > 1 && (
                  <tr className="border-t-2 border-gray-400 bg-gradient-to-r from-gray-200 to-gray-100 font-bold">
                    ...
                    <td className="text-right py-4 px-4 font-bold text-white bg-clay">
