...
export default function TemporadasAdmin() {
  ...
  useEffect(() => {
    document.title = "Admin - Temporadas | Eco Area Limonar";
  }, []);
    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="mb-8 flex gap-4 items-center">
        ...
        <select
          ...
          className="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-earth focus:border-transparent"
        >
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex items-center justify-between p-6 border-b border-gray-200">
              <h2 className="text-2xl font-bold text-gray-900 flex items-center gap-2">
                <Edit2 className="h-6 w-6 text-earth" />
                Editar Temporada
              </h2>
              <button
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-earth focus:border-transparent"
                />
              </div>
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="w-4 h-4 text-earth focus:ring-earth border-gray-300 rounded"
                />
            ...
            <div className="flex items-center justify-end gap-3 p-6 border-t border-gray-200 bg-gray-50">
              ...
              <button
                ...
                className="px-6 py-2 bg-earth text-white rounded-lg font-medium hover:bg-blue-700 transition-colors flex items-center gap-2"
              >
