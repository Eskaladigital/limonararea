...
export const metadata: Metadata = {
  title: "Admin - Dashboard | Eco Area Limonar",
};
          ...
          {alerts.map((alert, idx) => (
            <Link
              ...
              className={`
                ...
                ${alert.color === 'orange' ? 'bg-clay/10 border-orange-200' : ''}
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <Link
            ...
            className="flex items-center gap-3 p-4 bg-clay/10 hover:bg-clay/20 rounded-lg transition-colors"
          >
            <Calendar className="h-6 w-6 text-clay" />
            <span className="font-medium text-gray-900">Nueva reserva</span>
          </Link>
          <Link
            href="/administrator/parcelas/nuevo"
            className="flex items-center gap-3 p-4 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors"
          >
            <Car className="h-6 w-6 text-blue-600" />
            <span className="font-medium text-gray-900">Añadir parcela</span>
          </Link>
          <Link
            href="/administrator/calendario"
