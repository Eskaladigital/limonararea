          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div className="mt-4 flex items-center gap-2 text-sm text-gray-500">
              ...
              <input 
                ...
                className="flex-1 border-0 border-b border-dashed border-gray-300 focus:ring-0 focus:border-clay p-0 text-gray-700" 
              />
            </div>
          </div>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <textarea 
                      ...
                      rows={3} 
                      className="w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-clay focus:border-transparent" 
                ...
                <div className="space-y-6">
                  ...
                  <div className="p-4 bg-gray-50 rounded-lg">
                    ...
                    <p className="text-green-700 text-sm">
                      ecoarealimonar.com/blog/{slug || "url-del-articulo"}
                    </p>
            ...
            <div className="space-y-4">
              <div>
                ...
                <select 
                  ...
                  className="w-full border border-gray-300 rounded-lg p-2 focus:ring-2 focus:ring-clay focus:border-transparent"
                >
              ...
              <label className="flex items-center gap-3 cursor-pointer">
                <input 
                  ...
                  className="w-4 h-4 rounded border-gray-300 text-clay focus:ring-clay" 
                />
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            {featuredImage ? (
              ...
              <button 
                ...
                className="w-full h-40 border-2 border-dashed border-gray-300 rounded-lg flex flex-col items-center justify-center text-gray-500 hover:border-clay hover:text-clay transition-colors"
              >
