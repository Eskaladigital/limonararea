...
export default function BlogPostsPage() {
  ...
  useEffect(() => {
    document.title = "Admin - Blog | Eco Area Limonar";
  }, []);
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        {loading ? (
          <div className="p-12 text-center text-gray-500">
            <div className="inline-block animate-spin rounded-full h-8 w-8 border-b-2 border-clay mb-4"></div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <select
                      ...
                      className="px-3 py-1 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-clay focus:border-transparent"
                    >
