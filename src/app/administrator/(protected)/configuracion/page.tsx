...
export default function ConfiguracionPage() {
  ...
  useEffect(() => {
    document.title = "Admin - Configuración | Eco Area Limonar";
  }, []);
  ...
  const [formData, setFormData] = useState({
    ...
    contactEmail: process.env.COMPANY_EMAIL || process.env.INFO_EMAIL || 'info@ejemplo.com',
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          <div className="flex items-center gap-3 mb-6">
            <Globe className="h-6 w-6 text-clay" />
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
              ...
              <input
                ...
                className="w-5 h-5 text-clay focus:ring-clay border-gray-300 rounded"
              />
            </div>
