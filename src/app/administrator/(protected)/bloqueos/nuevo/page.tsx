...
export default function NuevoBloqueoPage() {
  ...
  const loadParcels = async () => {
    try {
      ...
      setMessage({ type: 'error', text: error.message || 'Error al cargar las parcelas' });
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.parcel_id || !formData.start_date || !formData.end_date) {
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div>
              ...
              <select
                ...
                required
              >
                <option value="">Selecciona un parcela</option>
                {parcels.map(parcel => (
              ...
              <div className="flex flex-wrap gap-2">
                ...
                {REASON_OPTIONS.map(option => (
                  <button
                    ...
                    className="px-3 py-1 text-sm bg-gray-100 text-gray-700 rounded-full hover:bg-clay hover:text-white transition-colors"
                  >
                    {option.label}
                  </button>
                ))}
          ...
          <div className="bg-red-50 border border-red-200 rounded-xl p-6">
            ...
            <ul className="space-y-2 text-sm text-red-800">
              <li className="flex gap-2">
                <span>•</span>
                <span>El parcela NO estará disponible para alquilar durante este período</span>
              </li>
              <li className="flex gap-2">
                <span>•</span>
