...
type SortField = 'parcel' | 'internal_code' | 'start_date' | 'end_date' | 'reason' | 'created_at';
...
export default function BloqueosPag() {
  useEffect(() => {
    document.title = "Admin - Bloqueos | Eco Area Limonar";
  }, []);
  ...
  const filteredAndSorted = useMemo(() => {
    ...
    let filtered = blockedDates.filter(block => {
      ...
      return (
        block.parcel?.name?.toLowerCase().includes(search) ||
        block.parcel?.internal_code?.toLowerCase().includes(search) ||
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 flex items-center gap-3">
            ...
            Bloqueos de Parcelas
          </h1>
          <p className="text-gray-600 mt-1">
            Gestiona períodos en los que las parcelas no están disponibles para reserva
          </p>
        </div>
        <Link
          href="/administrator/bloqueos/nuevo"
          className="inline-flex items-center gap-2 px-4 py-2 bg-clay text-white rounded-lg hover:bg-clay-dk transition-colors font-medium"
        >
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
        <div className="relative">
          ...
          <input
            type="text"
            placeholder="Buscar por parcela, código interno o razón..."
            value={searchTerm}
              ...
              <tr>
                <th className="px-6 py-3 text-left">
                  <button
                    ...
                    className="flex items-center gap-2 text-xs font-medium text-gray-700 uppercase tracking-wider hover:text-clay transition-colors"
                  >
                    Código
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <div className="flex items-center justify-end gap-2">
                          <Link
                            ...
                            className="p-2 text-gray-600 hover:text-clay hover:bg-clay/10 rounded-lg transition-colors"
                            title="Editar"
                          >
        ...
        <div className="flex gap-3">
          ...
          <div className="text-sm text-blue-900">
            ...
            <ul className="list-disc list-inside space-y-1 text-blue-800">
              <li>Las parcelas bloqueadas NO aparecerán en las búsquedas de disponibilidad durante las fechas bloqueadas</li>
