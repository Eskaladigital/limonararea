  ...
  if (!booking) {
    return (
      <div className="text-center py-12">
        ...
        <Link href="/administrator/reservas" className="text-clay hover:underline">
          Volver a reservas
        </Link>
      </div>
    );
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        {/* Price Summary */}
        <div className="bg-gradient-to-br from-clay to-clay-dk text-white rounded-xl shadow-sm p-6">
          <div className="flex items-center gap-3 mb-4">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                ...
                className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-earth hover:bg-earth/10 rounded-lg transition-colors"
              >
            ...
            {booking.customer ? (
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <a href={`mailto:${booking.customer.email}`} className="text-earth hover:text-clay flex items-center gap-2">
                ...
                <div className="pt-4 border-t border-gray-200">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-clay">{booking.customer.total_bookings}</p>
                    </div>
                    <div>
