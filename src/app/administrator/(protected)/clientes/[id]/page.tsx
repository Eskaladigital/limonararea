  ...
  if (!customer) {
    return (
      <div className="text-center py-12">
        ...
        <Link href="/administrator/clientes" className="text-clay hover:underline">
          Volver a clientes
        </Link>
      </div>
    );
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-full bg-gradient-to-br from-earth to-blue-600 flex items-center justify-center text-white font-bold text-xl">
        ...
        <div className="flex gap-3">
          <Link
            ...
            className="inline-flex items-center gap-2 px-4 py-2 bg-clay text-white rounded-lg hover:bg-clay-dk transition-colors text-sm font-medium shadow-sm"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          <div className="flex items-center justify-between mb-2">
            ...
            <Car className="h-5 w-5 text-earth" />
          </div>
          <p className="text-3xl font-bold text-earth">{customer.total_bookings || 0}</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <a href={`mailto:${customer.email}`} className="text-earth hover:text-clay flex items-center gap-2">
              ...
              {customer.phone && (
                <div>
                  ...
                  <a href={`tel:${customer.phone}`} className="text-earth hover:text-clay flex items-center gap-2">
          ...
          {customer.notes && (
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                <FileText className="h-6 w-6 text-earth" />
                Notas Internas
              </h3>
              ...
              <div className="space-y-4">
                {bookings.map((booking) => (
                  <Link
                    ...
                    className="block p-4 border border-gray-200 rounded-lg hover:border-clay hover:shadow-md transition-all"
                  >
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="text-right flex-shrink-0">
                        <p className="text-2xl font-bold text-clay mb-2">
