...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description:
      "Contactez Eco Area Limonar. Paraje El Limonar, Los Nietos, Cartagena - Murcia. Nous sommes là pour répondre à toutes vos questions sur votre séjour.",
    keywords:
      "contact eco area limonar, téléphone aire camping-car Los Nietos, email camping Mar Menor",
    openGraph: {
      title: "Contact | Eco Area Limonar",
      description:
        "Contactez-nous pour réserver votre emplacement au Mar Menor.",
      type: "website",
