...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  try {
    ...
    locale = (headersList.get('x-detected-locale') || 'fr') as Locale;
  } catch {
    locale = 'fr';
  }
  ...
  const description = parcel.short_description
    || `Location de ${parcel.name} chez Eco Area Limonar. Emplacement entièrement équipé à partir de ${formatPrice(parcel.base_price_per_day)}/jour.`;
