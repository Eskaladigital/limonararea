...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: "Emplacements camping-car | Eco Area Limonar",
    description:
      "Découvrez nos emplacements spacieux et équipés à Los Nietos, Mar Menor. Électricité, eau, WiFi et tous les services inclus. À partir de 95€/jour.",
    keywords:
      "emplacements camping-car, camping Mar Menor, eco area limonar emplacements, Los Nietos emplacements, Cartagena",
    openGraph: {
      title: "Emplacements camping-car | Eco Area Limonar",
      description:
        "Emplacements spacieux avec tous les services au Mar Menor. À partir de 95€/jour.",
      type: "website",
