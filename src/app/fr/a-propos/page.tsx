...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: "À propos | Eco Area Limonar",
    description:
      "Découvrez Eco Area Limonar, une aire de camping-cars à Los Nietos, au bord du Mar Menor. Emplacements premium, services complets et 320 jours de soleil.",
    keywords:
      "eco area limonar, à propos, aire camping-car Los Nietos, camping Mar Menor, Cartagena Murcie",
    openGraph: {
      title: "À propos | Eco Area Limonar",
      description:
        "Aire de camping-cars premium au bord du Mar Menor. Découvrez notre histoire.",
      type: "website",
