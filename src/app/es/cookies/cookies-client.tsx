...
export function CookiesClient() {
  ...
  return (
    <main className="min-h-screen bg-white">
      <section className="bg-earth-deep py-12">
        ...
        <div className="container mx-auto px-4">
          <div className="bg-white rounded-xl shadow-sm p-8 max-w-4xl mx-auto prose prose-gray max-w-none">
            ...
            <table>
              ...
              <tbody>
                <tr><td>ecoarealimonar_cookie_consent</td><td>1 año</td><td>Almacena si has dado consentimiento</td></tr>
                <tr><td>ecoarealimonar_cookie_preferences</td><td>1 año</td><td>Almacena tus preferencias de cookies</td></tr>
              </tbody>
            </table>
            ...
            <button
              ...
              className="bg-earth-deep text-white px-6 py-3 rounded-lg font-semibold hover:bg-earth-deep-dark transition-colors"
            >
              Configurar cookies
            </button>
            ...
            <ul>
              <li><strong>Email:</strong> privacidad@ecoarealimonar.com</li>
