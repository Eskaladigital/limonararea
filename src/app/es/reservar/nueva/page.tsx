...
function NuevaReservaContent() {
  ...
  return (
    <>      
      <main className="min-h-screen bg-sand-lt pt-8 py-12">
            ...
            <div className="lg:col-span-2">
              <form id="reservation-form" onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-sm p-6 md:p-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-2">
                  <User className="h-6 w-6 text-earth" />
                  {t("Tus datos")}
                </h2>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-earth focus:border-transparent"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-earth focus:border-transparent min-w-0 max-w-full box-border"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-earth focus:border-transparent bg-white"
                      >
                  ...
                  <div className="pt-4 border-t border-gray-200">
                    <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2">
                      <FileText className="h-5 w-5 text-earth" />
                  ...
                  <div className="pt-4">
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-earth focus:border-transparent resize-none"
                  ...
                  <div className="pt-4 border-t border-gray-200">
                    <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2">
                      <Tag className="h-5 w-5 text-earth" />
                      ...
                      <div className="space-y-3">
                        <div className="flex gap-3">
                          <input
                            ...
                            className="flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-earth focus:border-transparent uppercase"
                          ...
                          <button
                            ...
                            className="px-6 py-3 bg-earth text-white font-semibold rounded-lg hover:bg-earth-deep transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                          >
                            {couponLoading ? (
                ...
                <div className="mt-8 pt-6 border-t border-gray-200">
                  <button
                    type="submit"
                    disabled={submitting}
                    className="w-full bg-clay text-white font-semibold py-4 px-6 rounded-lg hover:bg-orange-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    {submitting ? (
                      <>
                        <Loader2 className="h-5 w-5 animate-spin" />
                ...
                <div className="bg-white rounded-2xl shadow-sm p-6 sticky top-24">
                  ...
                  <div className="space-y-3 mb-6 pb-6 border-b border-gray-200">
                    <div className="flex items-start gap-3">
                      <Calendar className="h-5 w-5 text-earth flex-shrink-0 mt-0.5" />
                      <div className="text-sm">
                        <p className="text-gray-500">{t("Entrada")}</p>
                    ...
                    <div className="flex items-start gap-3">
                      <Calendar className="h-5 w-5 text-earth flex-shrink-0 mt-0.5" />
                      <div className="text-sm">
                        <p className="text-gray-500">{t("Salida")}</p>
                        <p className="font-semibold text-gray-900">
                  ...
                  {/* Lugar de estancia (único: Eco Area Limonar) */}
                  <div className="space-y-3 mb-6 pb-6 border-b border-gray-200">
                    <div className="flex items-start gap-3">
                      <MapPin className="h-5 w-5 text-earth flex-shrink-0 mt-0.5" />
                      <div className="text-sm">
                        <p className="text-gray-500">{t("Lugar de estancia")}</p>
                        <p className="font-semibold text-gray-900">{pickupLocation?.name || t("Eco Area Limonar, Los Nietos")}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="pt-4 border-t border-gray-200">
                    <div className="flex justify-between items-center">
                      ...
                      <div className="text-right">
                        ...
                        <span className="text-3xl font-bold text-clay">{formatPrice(totalPrice)}</span>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-4 py-3">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-clay transition-all duration-300">{formatPrice(totalPrice)}</p>
            </div>
            <button
              type="submit"
              form="reservation-form"
              disabled={submitting}
              className="bg-clay text-white font-bold py-3 px-6 rounded-xl hover:bg-orange-600 active:scale-95 transition-all flex items-center gap-2 shadow-lg shadow-orange-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {submitting ? (
                <>
                  <Loader2 className="h-5 w-5 animate-spin" />
