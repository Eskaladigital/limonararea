...
export default function ConfirmacionPage() {
  ...
  const bankDetails = {
    ...
    bic: 'ABCDESXX',
    holder: 'ECO AREA LIMONAR SL',
  };

  // Actualizar título del navegador
  useEffect(() => {
    document.title = 'Confirmación de reserva - Eco Area Limonar';
  }, []);
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6 md:p-8 mb-6">
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 bg-sand-lt rounded-lg">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <button
                    ...
                    className="text-sm text-earth hover:text-clay transition-colors flex items-center gap-1"
                  >
                    {copied === 'iban' ? (
                      <>
              ...
              <div className="p-6 bg-gradient-to-r from-clay to-orange-600 rounded-lg text-white">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6 md:p-8">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                <div className="w-8 h-8 bg-clay text-white rounded-full flex items-center justify-center font-bold flex-shrink-0">
                  1
                </div>
                <div>
            ...
            <div className="mt-6 pt-6 border-t border-gray-200 text-center">
              ...
              <Link 
                href="/"
                className="inline-block bg-earth text-white font-semibold py-3 px-6 rounded-lg hover:bg-earth-deep transition-colors"
              >
                {t("Volver al inicio")}
              </Link>
            </div>
