...
export default function PagoPage() {
  ...
  useEffect(() => {
    document.title = 'Pago de reserva - Eco Area Limonar';
  }, []);
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6 md:p-8 mb-6">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-4">
                {t("Número de reserva")}: <span className="font-mono font-bold text-clay">{booking.booking_number}</span>
              </p>
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6 md:p-8 mb-6">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-start gap-4 p-4 bg-sand-lt rounded-lg">
                  <Calendar className="h-6 w-6 text-earth flex-shrink-0 mt-1" />
                  <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-start gap-4 p-4 bg-blue-50 rounded-lg">
                  <MapPin className="h-6 w-6 text-earth flex-shrink-0 mt-1" />
                  <div>
              ...
              {/* Customer */}
              <div className="flex items-start gap-4 p-4 bg-sand-lt rounded-lg">
                <User className="h-6 w-6 text-earth flex-shrink-0 mt-1" />
              ...
              {/* Price Summary */}
              <div className="p-6 bg-gradient-to-r from-earth to-earth-deep rounded-lg text-white">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6 md:p-8">
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                      paymentMethod === 'redsys' ? 'border-clay' : 'border-gray-300'
                    }`}>
                      {paymentMethod === 'redsys' && (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                      paymentMethod === 'stripe' ? 'border-clay' : 'border-gray-300'
                    }`}>
                      {paymentMethod === 'stripe' && (
                        <div className="w-3 h-3 rounded-full bg-clay"></div>
                      )}
            ...
            {!paymentInfo.isPending50 && (
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                <h3 className="font-semibold text-earth-deep mb-2">
                  {t("Política de pago Eco Area Limonar")}
                </h3>
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                disabled={processing}
                className="w-full bg-clay text-white font-semibold py-4 px-6 rounded-lg hover:bg-orange-600 transition-colors flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {processing ? (
                  <>
              ...
              {!paymentInfo.isPending50 && (
                <button
                  ...
                  disabled={processing}
                  className="w-full bg-white text-earth border-2 border-earth font-semibold py-4 px-6 rounded-lg hover:bg-blue-50 transition-colors flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <CreditCard className="h-5 w-5" />
            ...
            <div className="mt-4 text-center">
              <Link 
                href="/"
                className="inline-flex items-center gap-2 text-sm text-gray-600 hover:text-clay transition-colors"
              >
