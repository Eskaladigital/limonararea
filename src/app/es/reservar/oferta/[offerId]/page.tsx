...
export default function ReservarOfertaPage({ 
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-sand-lt">
        <div className="text-center">
          <Loader2 className="w-12 h-12 animate-spin text-earth mx-auto mb-4" />
  ...
  if (error || !offer) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-sand-lt p-4">
        <div className="bg-white rounded-2xl shadow-lg p-8 max-w-md text-center">
          ...
          <LocalizedLink
            href="/ofertas"
            className="inline-flex items-center gap-2 bg-earth text-white px-6 py-3 rounded-xl hover:bg-earth-deep transition-colors"
          >
    ...
    <main className="min-h-screen bg-sand-lt py-8">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="mb-8">
          <LocalizedLink 
            href="/ofertas"
            className="inline-flex items-center gap-2 text-earth hover:underline mb-4"
          >
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-gradient-to-r from-clay/10 to-orange-50 rounded-2xl p-6 border-2 border-clay/30">
              <div className="flex items-center gap-2 mb-4">
                <Lock className="w-5 h-5 text-clay" />
                <h2 className="text-lg font-bold text-gray-900">{t("Oferta Seleccionada")}</h2>
                <span className="ml-auto bg-clay text-white text-sm font-bold px-3 py-1 rounded-full">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-earth focus:border-transparent"
                  >
                ...
                <div className="space-y-3">
                  {extras.map(extra => {
                    ...
                    return (
                      <div 
                        key={extra.id}
                        className="flex items-center justify-between p-4 border border-gray-200 rounded-xl hover:border-earth transition-colors"
                      >
                        <div className="flex-1">
                          ...
                          <p className="text-sm font-medium text-clay mt-2">
                            {priceDisplay}
                            {maxQuantity > 1 && (
                            ...
                            quantity > 0 ? (
                              <>
                                <button
                                  ...
                                  className="w-8 h-8 flex items-center justify-center rounded-full border-2 border-gray-300 hover:border-clay hover:text-clay transition-colors"
                                >
                                ...
                                <button
                                  ...
                                  className={`w-8 h-8 flex items-center justify-center rounded-full border-2 transition-colors ${
                                    quantity >= maxQuantity
                                      ...
                                      : 'border-clay bg-clay text-white hover:bg-orange-600'
                                  }`}
                                >
                              ...
                              <button
                                type="button"
                                onClick={() => addExtra(extra)}
                                className="px-4 py-2 bg-earth text-white text-sm font-semibold rounded-lg hover:bg-earth-deep transition-colors"
                              >
                                {t("Añadir")}
                              </button>
                            )
                            ...
                            <button
                              ...
                              className={`px-4 py-2 text-sm font-semibold rounded-lg transition-colors ${
                                quantity > 0
                                  ...
                                  : 'bg-earth text-white hover:bg-earth-deep'
                              }`}
                            >
            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-sm p-6">
              <h2 className="text-lg font-bold text-gray-900 mb-4 flex items-center gap-2">
                <User className="w-5 h-5 text-earth" />
              ...
              <div className="mt-6 flex items-start gap-3">
                <input
                  ...
                  className="mt-1 w-5 h-5 rounded border-gray-300 text-earth focus:ring-earth"
                />
                <label htmlFor="terms" className="text-sm text-gray-600">
                  {t("He leído y acepto los")}{" "}
                  <LocalizedLink href="/terminos-y-condiciones" className="text-earth hover:underline">
                    {t("términos y condiciones")}
                  </LocalizedLink>{" "}
                  {t("y la")}{" "}
                  <LocalizedLink href="/politica-de-privacidad" className="text-earth hover:underline">
              ...
              <button
                ...
                className="mt-6 w-full bg-clay hover:bg-clay-dk text-white font-bold py-4 px-8 rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {submitting ? (
                  <>
            ...
            <div className="bg-white rounded-2xl shadow-sm p-6 sticky top-24">
              ...
              <div className="space-y-3 pb-4 border-b border-gray-100">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium text-clay">{offer.offer_days} {t("días")}</span>
                </div>
              </div>
              ...
              <div className="pt-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-2xl font-bold text-earth">{formatPrice(totalPrice)}</span>
                </div>
              ...
              <div className="mt-6 p-4 bg-blue-50 rounded-xl">
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-earth flex-shrink-0 mt-0.5" />
