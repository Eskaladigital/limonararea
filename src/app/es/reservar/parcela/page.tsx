...
import { 
  ArrowLeft, Calendar, MapPin, ArrowRight, Plus, Minus, AlertCircle, Loader2, Ruler, Car, Info
} from"lucide-react";
...
<div className="min-h-screen bg-sand-lt flex items-center justify-center">
  ...
  return (
    <>
<main className="min-h-screen bg-sand-lt pt-6 pb-6 md:pt-8 md:pb-12 overflow-x-hidden">
        <div className="container mx-auto px-4 max-w-7xl">
          {/* Link Volver - Simple y elegante */}
          <div className="mb-4">
            <LocalizedLink 
              href={`/buscar?${searchParams.toString()}`}
              className="inline-flex items-center text-sm text-gray-600 hover:text-clay transition-colors group"
            >
              ...
              {(parcel.length_m || parcel.width_m) && (
                <div className="bg-white rounded-xl md:rounded-2xl shadow-sm p-4 md:p-6">
                  ...
                  <div className="grid grid-cols-3 gap-2 md:gap-4">
                    {parcel.length_m && (
                      <div className="text-center p-3 md:p-4 bg-sand-lt rounded-lg">
                        <Ruler className="h-5 w-5 md:h-6 md:w-6 mx-auto text-gray-400 mb-1 md:mb-2" />
                        <p className="font-bold text-sm md:text-base">{parcel.length_m} m</p>
                        <p className="text-xs md:text-sm text-gray-500">{t("Largo")}</p>
                      </div>
                    ...
                    {parcel.height_m && (
                      <div className="text-center p-3 md:p-4 bg-sand-lt rounded-lg">
                        <Ruler className="h-5 w-5 md:h-6 md:w-6 mx-auto text-gray-400 mb-1 md:mb-2" />
                        <p className="font-bold text-sm md:text-base">{parcel.height_m} m</p>
                      ...
                      <div className="space-y-3">
                        {categoryExtras.map(extra => {
                          ...
                          return (
                            <div 
                              key={extra.id}
                              className="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:border-earth transition-colors"
                            >
                                      ...
                                      <button
                                        ...
                                        className={`w-8 h-8 flex items-center justify-center rounded-full border-2 transition-colors ${
                                          quantity <= (extra.min_quantity ?? 0)
                                            ...
                                            : 'border-gray-300 hover:border-clay hover:text-clay'
                                        }`}
                                      >
            ...
            <div className="hidden lg:block lg:sticky lg:top-24 lg:self-start lg:h-fit">
              <div className="bg-white rounded-2xl shadow-sm p-6">
                ...
                <div className="space-y-3 mb-6 pb-6 border-b border-gray-200">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-sm">
                      ...
                      <p className="font-semibold text-gray-900">{t("Eco Area Limonar, Los Nietos")}</p>
                    </div>
                  </div>
                </div>
                ...
                <button
                  ...
                  className="w-full bg-clay text-white font-semibold py-4 px-6 rounded-lg hover:bg-orange-600 transition-colors flex items-center justify-center gap-2"
                >
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-[0_-4px_20px_rgba(0,0,0,0.1)] z-[60] safe-area-inset-bottom">
        <div className="container mx-auto px-4 py-3">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={handleContinue}
              className="bg-clay text-white font-bold py-3 px-8 rounded-xl hover:bg-orange-600 active:scale-95 transition-all flex items-center gap-2 shadow-lg shadow-orange-200"
            >
              {t("Continuar")}
              <ArrowRight className="h-5 w-5" />
            </button>
