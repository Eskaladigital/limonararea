...
export function VideoTutorialesClient() {
  ...
  return (
    <main className="min-h-screen bg-white">
      {/* Hero */}
      <section className="bg-gradient-to-br from-earth via-earth-deep to-earth-deep py-20 relative overflow-hidden">
      ...
      {/* CTA */}
      <section className="py-16 bg-sand-lt">
        <div className="container mx-auto px-4 text-center">
          ...
          <LocalizedLink 
            href="/guia-camper" 
            className="inline-flex items-center gap-2 bg-earth-deep text-white font-bold py-3 px-8 rounded-full hover:bg-earth-deep transition-colors"
          >
