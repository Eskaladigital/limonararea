...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: "Contacto | Eco Area Limonar",
    description:
      "Contacta con Eco Area Limonar. Paraje El Limonar, Los Nietos, Cartagena - Murcia. Estamos a tu disposición para resolver cualquier duda sobre tu estancia.",
    keywords:
      "contacto eco area limonar, telefono area autocaravanas Los Nietos, email camping Mar Menor",
    openGraph: {
      title: "Contacto | Eco Area Limonar",
      description:
        "Contacta con nosotros para reservar tu parcela en el Mar Menor.",
      type: "website",
...
export default async function ContactoPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* Contact grid — photo cards with overlay info */}
