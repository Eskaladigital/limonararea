...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: "Parcelas para Autocaravanas | Eco Area Limonar",
    description:
      "Descubre nuestras parcelas amplias y equipadas en Los Nietos, Mar Menor. Electricidad, agua, WiFi y todos los servicios incluidos. Desde 95€/día.",
    keywords:
      "parcelas autocaravanas, camping Mar Menor, eco area limonar parcelas, parcelas Los Nietos, Cartagena",
    openGraph: {
      title: "Parcelas para Autocaravanas | Eco Area Limonar",
      description:
        "Parcelas amplias con todos los servicios en el Mar Menor. Desde 95€/día.",
      type: "website",
...
export default async function ParcelasPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* Full-bleed photo with CTA overlay */}
