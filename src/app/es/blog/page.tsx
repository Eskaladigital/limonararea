...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: "Blog de Viajes en Autocaravana | Eco Area Limonar",
    description:
      "Consejos, rutas y experiencias para disfrutar del Mar Menor en autocaravana. Guías de viaje, destinos imprescindibles y vida camper en la costa de Murcia.",
    keywords:
      "blog autocaravana, viajes camper Mar Menor, rutas Murcia autocaravana, vida camper, eco area limonar blog",
    authors: [{ name: "Eco Area Limonar" }],
    openGraph: {
      title: "Blog de Viajes en Autocaravana | Eco Area Limonar",
      description:
        "Consejos, rutas y experiencias para tu próxima aventura en autocaravana en el Mar Menor.",
      type: "website",
