...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: "Quiénes Somos | Eco Area Limonar",
    description:
      "Conoce Eco Area Limonar, área de autocaravanas en Los Nietos, a orillas del Mar Menor. Parcelas premium, servicios completos y 320 días de sol.",
    keywords:
      "eco area limonar, quienes somos, area autocaravanas Los Nietos, camping Mar Menor, Cartagena Murcia",
    openGraph: {
      title: "Quiénes Somos | Eco Area Limonar",
      description:
        "Área de autocaravanas premium a orillas del Mar Menor. Conoce nuestra historia.",
      type: "website",
...
export default async function QuienesSomosPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* Values — large photo cards with overlay (Ballena Alegre style) */}
