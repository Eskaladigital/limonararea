...
function PagoCanceladoContent() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-sand-lt px-4">
      <div className="max-w-md w-full">
        <div className="bg-white rounded-lg shadow-lg p-8 text-center">
          ...
          <div className="space-y-3">
            {bookingId && (
              <Link
                href={`/reservar/${bookingId}/pago`}
                className="w-full inline-flex items-center justify-center px-6 py-3 bg-earth text-white rounded-lg hover:bg-earth-deep transition-colors font-medium"
              >
          ...
          <div className="mt-8 p-4 bg-blue-50 rounded-lg text-left">
            <h3 className="text-sm font-semibold text-earth-deep mb-2">
              ¿Necesitas ayuda?
            </h3>
    ...
    <Suspense fallback={
      <div className="min-h-screen flex items-center justify-center bg-sand-lt">
        <div className="text-center">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-earth mx-auto"></div>
