...
function PagoErrorContent() {
  ...
  return (
    <>
<main className="min-h-screen bg-gradient-to-b from-red-50 to-sand-lt py-12">
            ...
            <div className="p-8">
              ...
              <div className="space-y-4 mb-8">
                ...
                <ul className="space-y-3 text-gray-600">
                  <li className="flex items-start gap-3">
                    <RefreshCw className="h-5 w-5 text-earth mt-0.5 flex-shrink-0" />
                    <span>{t("Intentar de nuevo con la misma u otra tarjeta")}</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <HelpCircle className="h-5 w-5 text-earth mt-0.5 flex-shrink-0" />
                    <span>{t("Verificar que los datos de la tarjeta son correctos")}</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <Phone className="h-5 w-5 text-earth mt-0.5 flex-shrink-0" />
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full bg-clay text-white font-semibold py-3 px-6 rounded-lg hover:bg-clay-dk transition-colors flex items-center justify-center gap-2"
                >
              ...
              <div className="mt-8 pt-6 border-t border-gray-200">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <a
                    href="tel:+34XXX"
                    className="flex items-center justify-center gap-2 text-earth hover:text-earth-deep"
                  >
                  ...
                  >
                    ...
                    <span>info@ecoarealimonar.com</span>
                  </a>
                </div>
              </div>
            </div>
