      ...
      <div className="space-y-3">
        {bookingId && (
          <LocalizedLink
            ...
            className="block w-full bg-earth text-white font-semibold py-3 px-8 rounded-lg hover:bg-earth-deep transition-colors"
          >
            {t("Ver mi reserva")}
          </LocalizedLink>
        )}
        <LocalizedLink
          href="/"
          className={`block w-full ${bookingId ? 'bg-gray-100 text-gray-700 hover:bg-gray-200' : 'bg-clay text-white hover:bg-orange-600'} font-semibold py-3 px-8 rounded-lg transition-colors`}
        >
          {t("Volver al inicio")}
        </LocalizedLink>
      </div>
                ...
                <>
                  ...
                  <div className="space-y-4 mb-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="flex items-start gap-3 p-4 bg-blue-50 rounded-lg">
                        <Calendar className="h-5 w-5 text-earth mt-0.5" />
                        <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <LocalizedLink
                      ...
                      className="block w-full bg-earth text-white font-semibold py-3 px-6 rounded-lg hover:bg-earth-deep transition-colors text-center"
                    >
                      {t("Ver mi reserva")}
                    </LocalizedLink>
