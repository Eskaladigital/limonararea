...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: "Camperstandplaatsen | Eco Area Limonar",
    description:
      "Ontdek onze ruime en uitgeruste standplaatsen in Los Nietos, Mar Menor. Elektriciteit, water, WiFi en alle diensten inbegrepen. Vanaf 95€/dag.",
    keywords:
      "camperstandplaatsen, camping Mar Menor, eco area limonar standplaatsen, Los Nietos percelen, Cartagena, nl",
    openGraph: {
      title: "Camperstandplaatsen | Eco Area Limonar",
      description:
        "Ruime standplaatsen met alle diensten aan de Mar Menor. Vanaf 95€/dag.",
      type: "website",
