...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    keywords: "camperplaats, Los Nietos, Mar Menor, Cartagena, Murcia, camperstandplaatsen, camping, eco area limonar, nl",
...
export default async function LocaleHomePage() {
  ...
  return (
    <>
      ...
      {/* ══════ MAR MENOR - Nuestro mayor activo (entre parcelas e instalaciones) ══════ */}
