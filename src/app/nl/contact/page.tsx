...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description:
      "Neem contact op met Eco Area Limonar. Paraje El Limonar, Los Nietos, Cartagena - Murcia. Wij staan klaar om al uw vragen te beantwoorden.",
    keywords:
      "contact eco area limonar, telefoon camperplaats Los Nietos, email camping Mar Menor, nl",
    openGraph: {
      title: "Contact | Eco Area Limonar",
      description:
        "Neem contact met ons op om uw standplaats aan de Mar Menor te reserveren.",
      type: "website",
