...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: "Over Ons | Eco Area Limonar",
    description:
      "Ontdek Eco Area Limonar, een camperplaats in Los Nietos, aan de oevers van de Mar Menor. Premium standplaatsen, volledige service en 320 dagen zon.",
    keywords:
      "eco area limonar, over ons, camperplaats Los Nietos, camping Mar Menor, Cartagena Murcia, nl",
    openGraph: {
      title: "Over Ons | Eco Area Limonar",
      description:
        "Premium camperplaats aan de oevers van de Mar Menor. Ontdek ons verhaal.",
      type: "website",
