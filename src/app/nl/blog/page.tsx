...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: "Camper Reisblog | Eco Area Limonar",
    description:
      "Tips, routes en ervaringen om te genieten van de Mar Menor met de camper. Reisgidsen, must-see bestemmingen en camperleven aan de kust van Murcia.",
    keywords:
      "camper blog, camper reizen Mar Menor, Murcia camper routes, camperleven, eco area limonar blog",
    authors: [{ name: "Eco Area Limonar" }],
    openGraph: {
      title: "Camper Reisblog | Eco Area Limonar",
      description:
        "Tips, routes en ervaringen voor je volgende camperavontuur bij de Mar Menor.",
      type: "website",
