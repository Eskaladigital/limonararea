...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: "Wohnmobil-Reiseblog | Eco Area Limonar",
    description:
      "Tipps, Routen und Erfahrungen, um das Mar Menor mit dem Wohnmobil zu genießen. Reiseführer, Sehenswürdigkeiten und Camperleben an der Küste von Murcia.",
    keywords:
      "Wohnmobil Blog, Camper Reisen Mar Menor, Murcia Wohnmobil Routen, Camperleben, Eco Area Limonar Blog",
    authors: [{ name: "Eco Area Limonar" }],
    openGraph: {
      title: "Wohnmobil-Reiseblog | Eco Area Limonar",
      description:
        "Tipps, Routen und Erfahrungen für Ihr nächstes Wohnmobil-Abenteuer am Mar Menor.",
      type: "website",
