...
const categoryDescriptions: Record<string, string> = {
  ...
  parcelas: "Alles über Stellplätze für Wohnmobile: Typen, Ausstattung und Tipps.",
...
function formatDate(date: string, locale: string) {
  ...
  return new Date(date).toLocaleDateString(localeMap[locale] || "de-DE", {
    day: "numeric",
    month: "long",
    year: "numeric",
  });
