...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: "Kontakt | Eco Area Limonar",
    description:
      "Kontaktieren Sie Eco Area Limonar. Paraje El Limonar, Los Nietos, Cartagena - Murcia. Wir beantworten gerne alle Fragen zu Ihrem Aufenthalt.",
    keywords:
      "Kontakt Eco Area Limonar, Telefon Wohnmobilstellplatz Los Nietos, E-Mail Camping Mar Menor",
    openGraph: {
      title: "Kontakt | Eco Area Limonar",
      description:
        "Kontaktieren Sie uns, um Ihren Stellplatz am Mar Menor zu buchen.",
      type: "website",
