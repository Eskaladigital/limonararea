...
export function getFromEmail(): string {
  return process.env.SMTP_FROM_EMAIL || process.env.SMTP_USER || process.env.COMPANY_EMAIL || 'reservas@ejemplo.com';
}
...
export function getCompanyEmail(): string {
  return process.env.COMPANY_EMAIL || 'reservas@ejemplo.com';
}
