...
const CONTACT_EMAIL = process.env.COMPANY_EMAIL || 'reservas@ejemplo.com';
        ...
        <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="background-color: #ffffff; max-width: 600px;">
          ...
          <tr>
            <td align="center" style="background-color: #ffffff; padding: 25px 20px; border-bottom: 4px solid #063971;">
              <a href="${APP_URL}" style="text-decoration: none;">
                <img src="${APP_URL}/images/brand/logo.png" alt="Eco Area Limonar" width="200" style="display: block; max-width: 200px; height: auto;" />
              </a>
            </td>
          </tr>
          <!-- Content -->
          ...
          <tr>
            <td style="background-color: #f4f4f5; padding: 30px 20px; text-align: center;">
              <p style="margin: 0 0 10px 0; font-size: 14px; font-weight: bold; color: #374151;">Eco Area Limonar - Área de Autocaravanas</p>
              ...
              <p style="margin: 0 0 5px 0; font-size: 13px; color: #6b7280;">
                Email: <a href="mailto:${CONTACT_EMAIL}" style="color: #063971; text-decoration: none;">${CONTACT_EMAIL}</a>
              </p>
              <p style="margin: 0 0 15px 0; font-size: 13px; color: #6b7280;">
                Web: <a href="${APP_URL}" style="color: #063971; text-decoration: none;">${APP_URL.replace(/^https?:\/\//, '')}</a>
              </p>
...
export function getBookingCreatedTemplate(data: BookingEmailData): string {
  ...
  const content = `
    ...
    ${ctaButton('Ver mi reserva y proceder al pago', `${APP_URL}/es/reservar/${data.bookingId}`)}
    ...
    <tr>
      <td style="padding: 15px 20px 30px 20px;">
        ...
        <p style="margin: 0; font-size: 14px; color: #374151;">¡Gracias por confiar en Eco Area Limonar!</p>
      </td>
    </tr>
  `;
...
export function getFirstPaymentConfirmedTemplate(data: BookingEmailData): string {
  ...
  const content = `
    ...
    ${ctaButton('Ver detalles de mi reserva', `${APP_URL}/es/reservar/${data.bookingId}`)}
    ...
    <tr>
      <td style="padding: 10px 20px;">
        <ol style="margin: 0; padding-left: 20px; font-size: 13px; color: #374151; line-height: 1.8;">
          ...
          <li>Descarga y firma la <strong>documentación</strong> desde <a href="${APP_URL}/es/info" style="color: #063971;">${APP_URL.replace(/^https?:\/\//, '')}/es/info</a></li>
...
export function getSecondPaymentConfirmedTemplate(data: BookingEmailData): string {
  ...
  const content = `
    ...
    ${ctaButton('Ver mi reserva', `${APP_URL}/es/reservar/${data.bookingId}`)}
    ...
    <tr>
      <td style="padding: 10px 20px;">
        ...
        <p style="margin: 0; font-size: 13px; color: #374151;"><strong>📄 Contrato:</strong> Descarga y firma desde <a href="${APP_URL}/es/info" style="color: #063971;">${APP_URL.replace(/^https?:\/\//, '')}/es/info</a></p>
      </td>
    </tr>
    ...
    <tr>
      <td style="padding: 20px 20px 30px 20px;">
        ...
        <p style="margin: 0; font-size: 14px; color: #374151;">Un saludo,<br><strong>El equipo de Eco Area Limonar</strong></p>
      </td>
    </tr>
  `;
